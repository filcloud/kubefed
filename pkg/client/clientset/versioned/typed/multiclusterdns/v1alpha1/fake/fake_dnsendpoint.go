...
var dnsendpointsResource = schema.GroupVersionResource{Group: "multiclusterdns", Version: "v1alpha1", Resource: "dnsendpoints"}

var dnsendpointsKind = schema.GroupVersionKind{Group: "multiclusterdns", Version: "v1alpha1", Kind: "DNSEndpoint"}
