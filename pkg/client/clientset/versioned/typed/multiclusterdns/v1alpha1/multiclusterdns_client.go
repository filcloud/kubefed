...
import (
	...
	"sigs.k8s.io/kubefed/pkg/client/clientset/versioned/scheme"
)
...
// MulticlusterdnsV1alpha1Client is used to interact with features provided by the multiclusterdns group.
