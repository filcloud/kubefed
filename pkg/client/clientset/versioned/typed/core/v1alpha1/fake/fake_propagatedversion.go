...
var propagatedversionsResource = schema.GroupVersionResource{Group: "", Version: "v1alpha1", Resource: "propagatedversions"}

var propagatedversionsKind = schema.GroupVersionKind{Group: "", Version: "v1alpha1", Kind: "PropagatedVersion"}
