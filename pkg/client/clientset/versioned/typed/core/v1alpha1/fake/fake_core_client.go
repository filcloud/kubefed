...
import (
	...
	v1alpha1 "sigs.k8s.io/kubefed/pkg/client/clientset/versioned/typed/core/v1alpha1"
)
...
func (c *FakeCoreV1alpha1) ClusterPropagatedVersions(namespace string) v1alpha1.ClusterPropagatedVersionInterface {
	return &FakeClusterPropagatedVersions{c, namespace}
}
