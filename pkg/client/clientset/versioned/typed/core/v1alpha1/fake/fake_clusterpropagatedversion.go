...
var clusterpropagatedversionsResource = schema.GroupVersionResource{Group: "", Version: "v1alpha1", Resource: "clusterpropagatedversions"}

var clusterpropagatedversionsKind = schema.GroupVersionKind{Group: "", Version: "v1alpha1", Kind: "ClusterPropagatedVersion"}
...
func (c *FakeClusterPropagatedVersions) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterPropagatedVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clusterpropagatedversionsResource, c.ns, name), &v1alpha1.ClusterPropagatedVersion{})
...
func (c *FakeClusterPropagatedVersions) List(opts v1.ListOptions) (result *v1alpha1.ClusterPropagatedVersionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clusterpropagatedversionsResource, clusterpropagatedversionsKind, c.ns, opts), &v1alpha1.ClusterPropagatedVersionList{})
...
func (c *FakeClusterPropagatedVersions) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(clusterpropagatedversionsResource, c.ns, opts))
...
func (c *FakeClusterPropagatedVersions) Create(clusterPropagatedVersion *v1alpha1.ClusterPropagatedVersion) (result *v1alpha1.ClusterPropagatedVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clusterpropagatedversionsResource, c.ns, clusterPropagatedVersion), &v1alpha1.ClusterPropagatedVersion{})
...
func (c *FakeClusterPropagatedVersions) Update(clusterPropagatedVersion *v1alpha1.ClusterPropagatedVersion) (result *v1alpha1.ClusterPropagatedVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clusterpropagatedversionsResource, c.ns, clusterPropagatedVersion), &v1alpha1.ClusterPropagatedVersion{})
...
func (c *FakeClusterPropagatedVersions) UpdateStatus(clusterPropagatedVersion *v1alpha1.ClusterPropagatedVersion) (*v1alpha1.ClusterPropagatedVersion, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(clusterpropagatedversionsResource, "status", c.ns, clusterPropagatedVersion), &v1alpha1.ClusterPropagatedVersion{})
...
func (c *FakeClusterPropagatedVersions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(clusterpropagatedversionsResource, c.ns, name), &v1alpha1.ClusterPropagatedVersion{})
...
func (c *FakeClusterPropagatedVersions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(clusterpropagatedversionsResource, c.ns, listOptions)
...
func (c *FakeClusterPropagatedVersions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterPropagatedVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clusterpropagatedversionsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ClusterPropagatedVersion{})
