...
type ClusterPropagatedVersionsGetter interface {
	ClusterPropagatedVersions(namespace string) ClusterPropagatedVersionInterface
}
...
func newClusterPropagatedVersions(c *CoreV1alpha1Client, namespace string) *clusterPropagatedVersions {
